    ...
    try:
        ...
        def calculate_masked_index(calculation_array):
            ...
            if isinstance(calculation_array, tuple):
                ...
                # Gestionează calculele directe ca ExG
        ...
        exg = 2 * G - R - B
        indices['ExG'] = calculate_masked_index(exg)
        colormaps['ExG'] = 'YlGn'
...
def run_image_processor_with_gui_exg(image_path=None):
    """
...
if __name__ == "__main__":
    # Crează un fișier dummy pentru demonstrație dacă nu există
    ...
    run_image_processor_with_gui_exg(dummy_image_path)