...
def calculate_and_visualize_rgb_indices(image_path, output_dir):
    try:
        ...
        indices['GLI'] = calculate_masked_index((numerator_gli, denominator_gli))
        colormaps['GLI'] = 'viridis'
        ...
        for name, index_array in indices.items():
            ...
            # Dacă întreaga imagine (inclusiv fundalul negru) este NaN, este problematic
...
def run_image_processor_with_gui_gli(image_path=None):
    """
...
if __name__ == "__main__":
    ...
    run_image_processor_with_gui_gli(dummy_image_path)